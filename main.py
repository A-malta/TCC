...
def main():
    ...
    ttk.Label(frame_config, text="Configurações", background="#E0E7E9", font=fonte_titulo).grid(row=0, column=0, columnspan=2, pady=5, sticky="nsew")

    ttk.Label(frame_config, text="Velocidade (F):", background="#E0E7E9", font=fonte_padrao).grid(row=1, column=0, sticky="e", pady=2)
    ...
    ttk.Label(frame_plants, text="Select Plants", background="#E0E7E9", font=fonte_titulo).grid(row=0, column=0, columnspan=2, pady=5, sticky="nsew")
    ...
    bloco_frame.grid(row=7, column=0, columnspan=2, pady=(15, 5), sticky="nsew")
    ...
    frame_image.grid(row=0, column=1, rowspan=3, padx=20, pady=10, sticky="nsew")

    # Título "Imagem Coletada" em negrito
    ttk.Label(frame_image, text="Imagem Coletada", background="#E0E7E9", font=fonte_titulo).pack(pady=5, anchor="w")
